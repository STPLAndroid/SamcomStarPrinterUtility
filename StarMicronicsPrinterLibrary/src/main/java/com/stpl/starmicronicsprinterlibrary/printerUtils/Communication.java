...
public class Communication {
    ...
    interface SerialNumberCallback {
        void onSerialNumber(Result communicateResult, String serialNumber);
    }
...
class SendCommandThread extends Thread {
    ...
    private final Communication.SendCallback mCallback;
...
class SendCommandForRedirectionThread extends Thread {
    private final Object mLock;
    private final byte[] mCommands;
    private final List<PrinterSettings> mPrinterSettingsList;
    private final Context mContext;
    private final Communication.PrintRedirectionCallback mCallback;
...
class ParseDoNotCheckConditionThread extends Thread {
    private final Object mLock;
    private final IPeripheralCommandParser mParser;
    private StarIOPort mPort;
    private final Communication.SendCallback mCallback;
...
class RetrieveStatusThread extends Thread {
    private final Object mLock;
    private final Communication.StatusCallback mCallback;
...
class GetFirmwareInformationThread extends Thread {
    private final Object mLock;
    private final Communication.FirmwareInformationCallback mCallback;
