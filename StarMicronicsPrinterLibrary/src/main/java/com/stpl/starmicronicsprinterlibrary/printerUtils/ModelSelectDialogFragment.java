package com.stpl.starmicronicsprinterlibrary.printerUtils;
...
public class ModelSelectDialogFragment extends BaseDialogFragment {

    private Callback mCallbackTarget;

    public void setmCallbackTarget(Callback mCallbackTarget) {
        this.mCallbackTarget = mCallbackTarget;
    }
    ...
    private DialogInterface.OnClickListener mOnModelClickListener = new DialogInterface.OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            switch (which) {
                case 0:
                    model = ModelCapability.MC_PRINT2;
                    break;
                case 1:
                    model = ModelCapability.MC_PRINT3;
                    break;
                case 2:
            ...
            intentForPassingData.putExtra(Const.BUNDLE_KEY_MODEL_INDEX, model);

            mCallbackTarget.onDialogResult("", intentForPassingData);
...
//        mCallbackTarget = (Callback) getActivity();
